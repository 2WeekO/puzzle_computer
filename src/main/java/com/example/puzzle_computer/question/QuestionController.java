...
import com.example.puzzle_computer.answer.AnswerForm;
import com.example.puzzle_computer.user.UserService;
...
public class QuestionController {
    ...
    public String questionCreate(@Valid QuestionForm questionForm, BindingResult bindingResult, Principal principal) {
        ...
        this.questionService.create(questionForm.getSubject(), questionForm.getContent(), webUser);
    ...
    public String questionVote(Principal principal, @PathVariable("id") Integer id) {
        ...
        WebUser webUser = this.userService.getUser(principal.getName());
        this.questionService.vote(question, webUser);
        return String.format("redirect:/question/detail/%s", id);
    }
}