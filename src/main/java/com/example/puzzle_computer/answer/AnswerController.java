...
import com.example.puzzle_computer.question.QuestionService;
...
public class AnswerController {
    ...
    public String createAnswer(Model model, @PathVariable("id") Integer id,  @Valid AnswerForm answerForm, BindingResult bindingResult,Principal Principal) {
        ...
        this.answerService.create(question, answerForm.getContent(),webUser);
    ...
    public String answerVote(Principal principal, @PathVariable("id") Integer id) {
        Answer answer = this.answerService.getAnswer(id);
        WebUser webUser = this.userService.getUser(principal.getName());
        this.answerService.vote(answer, webUser);
        return String.format("redirect:/question/detail/%s", answer.getQuestion().getId());
    }
